...
urlpatterns = [
    ...
    path('resume/<int:id>', views.resumeDetail, name='resumeDetail'),
    path('employee/<int:id>', views.employeeIndex, name='employeeIndex'),
    path('employee/<int:id>/resume_sended', views.resumeSended, name='resumeSended'),
    path('employee/<int:id>/<int:jid>', views.resumeSend, name='resumeSend'),
    ...
    path('enterprise/<int:id>/Resume_received', views.resumeReceived, name='resumeReceived'),
    path('enterprise/<int:id>/Resume_received/<int:jid>/<int:rid>', views.resumeReceive, name='resumeReceive'),
    path('enterprise/<int:id>/Resume_received/<int:jid>/not<int:rid>', views.resumeRefuse, name='resumeRefuse'),
